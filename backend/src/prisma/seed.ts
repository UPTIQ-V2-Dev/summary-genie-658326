import { Role } from '../constants/role.constants.ts';
...
async function main() {
    ...
    const sampleSummary1 = await prisma.summary.upsert({
        ...
        create: {
            ...
            summary:
                'Lorem ipsum is a placeholder text commonly used in the printing and typesetting industry. It serves as a standard dummy text that allows designers and developers to focus on visual elements rather than content.',
            length: 'medium',
            style: 'paragraph',
            wordCount: 34,
            characterCount: 210,
